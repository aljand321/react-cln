            ...
            <form>
                <div className="card-body">
                    <div className="form-group">
                        ...
                        <textarea className="form-control" placeholder='Motivo de consulta' rows="5"></textarea>
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">                       
                        ...
                        <div className="input-group">
                            <div className="form-group">
                                ...
                                <textarea className="form-control"  rows="4" placeholder=" mmHg / Glasgow"></textarea>
                            </div>                            
                            <div className="form-group">
                                <label htmlFor="exampleInputEmail1">F.C. lat/min / 15 Glicemia</label>
                                <textarea className="form-control"  rows="4" placeholder="F.C. lat/min / 15 Glicemia"></textarea>
                            </div>
                            <div className="form-group">
                                <label htmlFor="exampleInputEmail1">F.R. C/min mg% Peso</label>
                                <textarea className="form-control"  rows="4" placeholder="F.R. C/min mg% Peso"></textarea>
                            </div>
                            <div className="form-group">
                                <label htmlFor="exampleInputEmail1">SaO2 % Kg Talla</label>
                                <textarea className="form-control"  rows="4" placeholder="SaO2 % Kg Talla"></textarea>
                            </div>
                            <div className="form-group">
                                <label htmlFor="exampleInputEmail1">Temp. °C Aux. Rec. cm  IMC</label>
                                
                                <textarea className="form-control" rows="4" placeholder="Temp. °C Aux. Rec. cm  IMC"></textarea>
                                ...
                                <div className="form-check">
                                    ...
                                    <label className="form-check-label" htmlFor="exampleCheck2">Rec.</label>
