...
function VerConsultaRetorno(props) {
    ...
    if(Object.keys(dataConsulta).length !== 0){
        const data = props.primeraConsulta.createdAt.split('T')[1]
                    ...
                    <div className="card-body">
                        ...
                        {props.dataPaciente !== 'null' && <div className="d-flex">
                            ...
                            <div className="p-2">
                                <div className="form-group">
                                    ...
                                    <p>Fecha: {props.primeraConsulta.createdAt.split('T')[0]}</p>
                                    <p>Hora:{hora}</p>
                                </div>
                            </div>
                        </div>}
                        <div className="row">
                            <div className="col-md-6">
                                ...
                                <div className="form-group">
                                    <label htmlFor="exampleInputEmail1">Auxiliar, Rectal</label>          
